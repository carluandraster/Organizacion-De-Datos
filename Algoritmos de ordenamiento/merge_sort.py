    ...
    while not esta_ordenado:
        ...
        if not esta_ordenado:
            ...
            while i < len(auxiliar1) or j < len(auxiliar2):
                while (i < len(auxiliar1) or j < len(auxiliar2)) and (primera_subiteracion1 or auxiliar1[i] > auxiliar1[i-1]) and (primera_subiteracion2 or auxiliar2[j] > auxiliar2[j-1]):
